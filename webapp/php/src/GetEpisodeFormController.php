...
【見出し（h1 / h2 / h3）の効果的な使い方】
- h1（level: 1）: 本文の冒頭に1つだけ。プレスリリース全体の主題を端的に示す大見出し。例：「新サービスの概要」「取り組みの背景」
- h2（level: 2）: メインセクションの区切り。背景・取り組み内容・今後の展望など、読者が拾い読みしやすい中見出し。2〜4個程度を目安に。
- h3（level: 3）: h2 の下位。同セクション内の細かい項目や補足を整理する小見出し。必要に応じて使用。
- 階層ルール: h1 → h2 → h3 の順でネスト。h2 の直後に h3 を置き、その後 paragraph で本文を記述。h1 の直後に h2 を飛ばして h3 は使わない。
...
【運用】
- 見出し: h1 で全体の主題を提示し、h2 でセクション分け、必要なら h3 で詳細を整理。読者がスクロールで拾い読みしやすい階層構造にすること
...
- 構成は 3〜6 段落程度、見出し（h1/h2/h3）・箇条書き・装飾を組み合わせて読みやすくリッチに仕上げる
PROMPT;
    }
